...
def merge_results():
    print("="*70)
    print("📊 MERGING GUI BATCH RESULTS")
    print("="*70)
    
    # Find all GUI batch files
    batch_files = sorted(glob.glob('cardtell_gui_batch_*.json'))
    ...
    with open(csv_file, 'w', encoding='utf-8', newline='') as f:
        writer = csv.DictWriter(f, fieldnames=[
            'name', 'set', 'set_code', 'card_number', 'prices',
